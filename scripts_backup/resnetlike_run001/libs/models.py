...
class Generator_CNN(nn.Module):
    ...
    def __init__(self, latent_dim, n_c, x_shape, verbose=False):
        ...
        self.rnb_15 = BasicBlock(x_channels, x_channels)
    ...
    def forward(self, zn, zc):
        ...
        x = self.rnb_14(x)
        x = self.rnb_15(x)
        x_gen = torch.sigmoid(self.Conv_gen_final(x))
...
class Encoder_CNN(nn.Module):
    ...
    def __init__(self, latent_dim, n_c, verbose=False):
        ...
        self.rnb_1 = BasicBlock(x_channels, x_channels)
        self.rnb_2 = BasicBlock(x_channels, x_channels)
        self.downsample_3 = nn.Sequential(nn.Conv2d(x_channels, 8, kernel_size=3, padding=1, stride=1, bias=True),
                                          nn.BatchNorm2d(8))
        self.rnb_3 = BasicBlock(x_channels, 8, downsample=self.downsample_3, stride=1)
        x_channels = 8
        ...
        self.downsample_6 = nn.Sequential(
            ...
            nn.BatchNorm2d(x_channels * 2))
        self.rnb_6 = BasicBlock(x_channels, x_channels * 2, downsample=self.downsample_6, stride=2)
        x_channels = x_channels * 2
        ...
        self.rnb_9 = BasicBlock(x_channels, x_channels, downsample=self.downsample_9, stride=1)
        ...
        self.downsample_12 = nn.Sequential(
            nn.Conv2d(x_channels, x_channels * 2, kernel_size=3, padding=1, stride=2, bias=True),
            nn.BatchNorm2d(x_channels * 2))
        self.rnb_12 = BasicBlock(x_channels, x_channels * 2, downsample=self.downsample_12, stride=2)
        x_channels = x_channels * 2
        ...
        self.downsample_15 = nn.Sequential(
            nn.Conv2d(x_channels, x_channels, kernel_size=3, padding=1, stride=1, bias=True),
            nn.BatchNorm2d(x_channels))
        self.rnb_15 = BasicBlock(x_channels, x_channels, downsample=self.downsample_15, stride=1)
        x_channels = x_channels
        ...
        self.downsample_18 = nn.Sequential(
            ...
            nn.BatchNorm2d(x_channels))
        self.rnb_18 = BasicBlock(x_channels, x_channels, downsample=self.downsample_18, stride=2)
        x_channels = x_channels
...
class Discriminator_CNN(nn.Module):
    ...
    def __init__(self, wass_metric=False, verbose=False):
        ...
        self.downsample_3 = nn.Sequential(nn.Conv2d(x_channels, 8, kernel_size=3, padding=1, stride=1, bias=True),
                                          nn.BatchNorm2d(8))
        self.rnb_3 = BasicBlock(x_channels, 8, downsample=self.downsample_3, stride=1) # 8x64x64
        x_channels = 8
        ...
        self.downsample_6 = nn.Sequential(
                nn.Conv2d(x_channels, x_channels * 2, kernel_size=3, padding=1, stride=2, bias=True),
                nn.BatchNorm2d(x_channels * 2))
        self.rnb_6 = BasicBlock(x_channels, x_channels * 2, downsample=self.downsample_6, stride=2) # 16x32x32
        x_channels = x_channels * 2
        ...
        self.downsample_9 = nn.Sequential(
                nn.Conv2d(x_channels, x_channels, kernel_size=3, padding=1, stride=1, bias=True),
                nn.BatchNorm2d(x_channels))
        self.rnb_9 = BasicBlock(x_channels, x_channels, downsample=self.downsample_9, stride=1) # 16x32x32
        x_channels = x_channels
